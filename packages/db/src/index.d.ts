...
export declare const db: import("drizzle-orm/bun-sqlite").BunSQLiteDatabase<Record<string, never>> & {
    $client: Database;
};
...
export declare const workspaceMembers: import("drizzle-orm/sqlite-core").SQLiteTableWithColumns<{
